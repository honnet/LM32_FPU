...
output	sda_oe;		// I2C serial data line output to be connected to control line of
			// bidirectional buffer on physical SDA line
input	sda_in;		// I2C serial data line input
output	sda_o;		// I2C sda line always asssign to zero this is to be connected to 
			// input of bidirectional buffer on physical SDA line
output	scl_oe;		// I2C serial clock line output to be connected to control line of 
			// bidirectiional buffer on physical scl line
